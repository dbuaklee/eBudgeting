...
insert into BUDGETTYPE (ID, NAME, "IDX", BUDGETTYPE_PARENT_ID, FISCALYEAR) values (0,'ROOT',0,NULL,2556)
insert into BUDGETTYPE (ID, NAME, "IDX", BUDGETTYPE_PARENT_ID, FISCALYEAR) values (1,'งบบุคลากร',0,0,2556)
insert into BUDGETTYPE (ID, NAME, "IDX", BUDGETTYPE_PARENT_ID, FISCALYEAR) values (2,'งบดำเนินงาน',1,0,2556)
insert into BUDGETTYPE (ID, NAME, "IDX", BUDGETTYPE_PARENT_ID, FISCALYEAR) values (3,'งบลงทุน',2,0,2556)
insert into BUDGETTYPE (ID, NAME, "IDX", BUDGETTYPE_PARENT_ID, FISCALYEAR) values (4,'งบอุดหนุน',3,0,2556)
insert into BUDGETTYPE (ID, NAME, "IDX", BUDGETTYPE_PARENT_ID, FISCALYEAR) values (5,'งบรายจ่ายอื่น',4,0,2556)
