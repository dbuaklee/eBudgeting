...
<div id="headLine">
	<h4>การปรับลดงบประมาณครั้งที่3 (อนุมัติตามพ.ร.บ.) ระดับรายการ</h4> 
</div>
...
<table class="table table-bordered" id="mainTbl" style="margin-bottom:0px; width:960px; table-layout:fixed;">
	<thead>
		<tr>
			<th style="width:325px;"><strong>แผนงาน/กิจกรรม ประจำปี {{this.0.fiscalYear}}</strong><br/>- ระดับ{{this.0.type.name}}</th>
	...
	<tbody>
		<tr>
			<td style="width:325px;text-align:right; padding-right: 20px;"><strong>รวมทั้งสิ้น</strong></td>
...
<script id="childrenNodeTemplate" type="text/x-handler-template">
	<tr data-level="{{this.level}}" data-id="{{this.id}}"  class="type-{{type.id}}">
		<td  style="width:325px;"  class="{{#if this.children}}disable{{/if}}">
