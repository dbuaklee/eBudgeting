	...
	พันธกิจ(120);
	 ...
	 public String getName() {
		if(id==100) {
			...
			return "เป้าประสงค์เชิงนโยบาย";
		} else if(id==114) {
			return "ยุทธศาสตร์กระทรวง";
		} else if(id==115) {
			return "ยุทธศาสตร์หน่วยงาน";
		} else if(id==116) {
			return "กลยุทธ์วิธีการหน่วยงาน";
		} else if(id==117) {
			return "";
		} else if(id==118) {
			return "แนวทางการจัดสรรงบประมาณ";
		} else if(id==119) {
			return "วิสัยทัศน์";
		} else if(id==120) {
			return "พันธกิจ";
